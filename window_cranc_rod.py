...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelTitleGraph.setText(_translate("MainWindow", "Визуализация данных"))
        self.toolButtonPosition.setText(_translate("MainWindow", "Построить положение механизма"))
        self.toolButtonSpeed.setText(_translate("MainWindow", "Построить план скоростей"))
        self.toolButtonAcceliration.setText(_translate("MainWindow", "Построить план ускорений"))
